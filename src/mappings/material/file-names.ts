import { FileNamePattern, parseByPattern } from "./patterns";
import { IconPack, MaterialFileExtensions } from "./types";
...
export const fileIcons = {
  ...
  icons: parseByPattern([
    ...
    {
      name: "terraform",
      fileExtensions: ["tf", "tf.json", "tfvars", "tfstate", "tfbackend", "terraformignore"],
    },
    {
      name: "opentofu",
      fileExtensions: ["tofu"],
    ...
    },
    {
      ...
      fileExtensions: ["css.ts", "css.js", "css.cjs", "css.mjs", "css.tsx", "css.jsx"],
    },
    {
      name: "claude",
    ...
    {
      name: "metro",
      fileNames: ["metro.config.js", "metro.config.cjs", "metro.config.mjs", "metro.config.json"],
    },
    {
      name: "bashly",
      patterns: {
...
} as const satisfies MaterialFileExtensions;
