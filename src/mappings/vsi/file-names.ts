...
import { VSIFileExtensions } from "./types";
...
export const extensions = {
  ...
  supported: [
    ...
    {
      icon: "bun",
      extensions: [".bun-version", ".bunfig.toml", "bunfig.toml", "bun.lockb", "bun.lock"],
    ...
    },
    {
      ...
      filename: true,
      languages: [languages.dockerbake, languages.dockercompose, languages.dockerfile],
    },
    {
      icon: "docker2",
      extensions: [".dockerignore"],
    ...
    {
      icon: "flutter",
      extensions: [".flutter-plugins", ".metadata", ".flutter-plugins-dependencies"],
      filename: true,
    },
    {
    ...
    {
      icon: "leanconfig",
      extensions: ["lakefile.lean", "lakefile.toml", "lake-manifest.json", "lean-toolchain"],
      light: true,
      filename: true,
    },
    {
      icon: "lefthook",
      extensions: [],
      filenamesGlob: ["lefthook", "lefthook-local", ".lefthook", ".lefthook-local"],
    ...
    {
      icon: "syncpack",
      extensions: [".syncpackrc", ".syncpackrc.json", ".syncpackrc.yaml", ".syncpackrc.yml"],
...
} as const satisfies VSIFileExtensions;
