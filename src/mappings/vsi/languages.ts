/**
 * Default language icon associations
 *
 * Found on:
 * https://github.com/vscode-icons/vscode-icons/blob/master/src/iconsManifest/languages.ts
 */
...
export const languages = {
  ...
  dockercompose: {
    ids: "dockercompose",
    knownFilenames: ["docker-compose.yml", "docker-compose.yaml", "compose.yaml", "compose.yml"],
  },
  dockerfile: {
    ids: "dockerfile",
    knownFilenames: ["Dockerfile", "Dockerfile.dev", "Dockerfile.prod", "Dockerfile.test"],
  },
  ...
  python: {
    ...
    knownFilenames: ["setup.py", "setup.cfg", ".python-version", "Pipfile", "Pipfile.lock"],
  },
